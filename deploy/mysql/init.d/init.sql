...
INSERT INTO `t_menu`(`id`, `pid`, `path`, `title`, `icon`, `type`, `authority`, `sort`, `created_at`, `updated_at`) VALUES (24, 2, '/admin/comment', '评论管理', 'comment', 'menu', '', 3, '2024-05-20 13:38:48', '2024-05-20 13:38:48');
